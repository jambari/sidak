...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="alert alert-info">
            ...
            <p><?php echo e(__('voyager.settings.usage_help')); ?> <code>setting('section.key')</code></p>
        </div>
        <?php endif; ?>
    </div>
            ...
            <div class="panel">
                ...
                <div class="page-content settings container-fluid">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="<?php echo e(str_slug($group)); ?>" class="tab-pane fade in <?php if($loop->first): ?> active <?php endif; ?>">
        ...
        <div class="panel" style="margin-top:10px;">
            ...
            <div class="panel-body">
                <form action="<?php echo e(route('voyager.settings.store')); ?>" method="POST">
                    ...
                    <div class="col-md-3">
                        <label for="asdf"><?php echo e(__('voyager.generic.type')); ?></label>
